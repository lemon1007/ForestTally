...
import s from '../stylesheets/sharedStyle/Tabs.module.scss';
...
export const Tabs = defineComponent({
  ...
  setup: (props, context) => {
    return () => {
      ...
      return <div class={[s.tabsComponent_wrapper, cp + '_tabs']}>
        <ol class={[s.tabsComponent_wrapper_nav, cp + '_tabs_nav']}>
          {tabs.map(item =>
            <li class={[
